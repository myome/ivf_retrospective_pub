...
png("./figures/prs_correlation_raw.png", width = 300, height = 250)
...
ggplot(rawscores,aes(x=measured,y=predicted,color = caseID)) + geom_point() + theme_bw() + theme(text = element_text(size=15))+labs(color="Case ID")
dev.off()
