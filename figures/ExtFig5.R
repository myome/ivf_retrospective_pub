...
ggsave("./figures/ExtFig5.pdf", plot=combinedplot, dpi=300, width=180, height=110, units=c("mm"), device="pdf")
ggsave("./figures/ExtFig5.jpg", plot=combinedplot, dpi=300, width=180, height=110, units=c("mm"), device="jpg")
