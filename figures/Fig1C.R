...
combinedplot<-ggarrange(cov, prscovbygt,error,prserrorbygt,ncol=2,nrow=2,  common.legend=TRUE, legend=c("bottom"), labels=c("Genome-wide", "Polygenic model sites"), font.label=list(color="black", size=6),hjust=-0.65)
