...
combinedplot<-ggarrange(cov, prscovbygt,error,prserrorbygt,ncol=2,nrow=2,  common.legend=TRUE, labels=c("Genome-wide", "Polygenic model sites"), font.label=list(color="black", size=6),hjust=-0.65)
ggsave("./figures/coverage_error_bygt.png", plot=combinedplot, dpi=300, width=3, height=3, units=c("in"))
dev.off()
