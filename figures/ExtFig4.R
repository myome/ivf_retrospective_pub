...
ggsave("./figures/ExtFig4.pdf", plot=histplot, dpi=300, width=180, height=225, units=c("mm"), device="pdf")
ggsave("./figures/ExtFig4.jpg", plot=histplot, dpi=300, width=180, height=225, units=c("mm"), device="jpg")
